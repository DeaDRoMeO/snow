/*
   ...
   Modified to work with phpBB3 - http://www.modphpbb3.com
   --------------------------------------------------------
   Description:
...
function SnowStorm() {
  ...
  var imagePath = 'ext/deadromeo/snow/styles/all/template/images/'; // relative path to snow images (including trailing slash)
  var flakesMax = 60;
